...
// ------------------------
 ...
 var requestApi = "https://localhost:7262/api/Formulario/"+codigoformulario
  ...
  .then(data => {
    $.ajax({
      ...
      success: function(response) {
        console.log("reponse: "+response.id_visualiza) 
        console.log("reponse: "+response.dirarcexT_CL) 
        console.log("reponse: "+response.dirarcexT_BL) 
        console.log("reponse: "+response.nomformu) 
        console.log("reponse: "+response.formulario) 
        ...
        if (response != "") {
          $('#borrar').remove();  
          $("#scroll-container").removeClass("sinresultadovh");
          rutacolor = response.dirarcexT_CL;
          rutabyn = response.dirarcexT_BL;
          let valorcod = response.formulario;
          let valornom = response.nomformu;
          valcbformuveri = response.formulario;
          if(ultimofocus == "cod"){
...
function cargarimagenvisor_bkp() {
